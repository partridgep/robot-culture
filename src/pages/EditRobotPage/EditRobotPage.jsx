...
class EditRobotPage extends Component {
    ...
    handleFinalSubmit = async (e) => {
        ...
        if (updatedCategory !== 'images') {
            ...
            robots = await robotsService.update(this.state.robot._id, updatedFields);
        } else {
            if (this.state.imageLandscape !== this.props.selRobot.imageLandscape) {
                updatedFields = {imageLandscape: this.state.imageLandscape};
                await robotsService.update(this.state.robot._id, updatedFields);
            }
            if (this.state.imagePortrait !== this.props.selRobot.imagePortrait) {
                updatedFields = {imagePortrait: this.state.imagePortrait};
                await robotsService.update(this.state.robot._id, updatedFields);
            }
            robots = await robotsService.index();
        }
    ...
    render() {
        return (
            <div>
                {this.state.robot && this.state.robot.name &&
                <div className='AddRobotPage'>
                    ...
                    {this.state.editPart === 3 &&
                        <div>
                        <h1 className='AddRobotPage-title'>Update {this.state.robot.name}'s Movies</h1>     
                        <AddMedia 
                            {... this.props} 
                            name={this.state.robot.name}
                    ...
                    {this.state.editPart === 4 &&
                        <div>
                        <h1 className='AddRobotPage-title'>Update {this.state.robot.name}'s Books</h1>     
                        <AddMedia 
                            {... this.props} 
                            name={this.state.robot.name}
                    ...
                    {this.state.editPart === 5 &&
                        <div>
                        <h1 className='AddRobotPage-title'>Update {this.state.robot.name}'s TV Shows</h1>     
                        <AddMedia 
                            {... this.props} 
                            name={this.state.robot.name}
                    ...
                    {this.state.editPart === 6 &&
                        <div>
                        <h1 className='AddRobotPage-title'>Update {this.state.robot.name}'s Games</h1>     
                        <AddMedia 
                            {... this.props} 
                            name={this.state.robot.name}
                    ...
                    {this.state.editPart === 7 &&
                        <div>
                        <h1 className='AddRobotPage-title'>Update the Actors for {this.state.robot.name}</h1>     
                        <AddMedia 
                            {... this.props} 
                            name={this.state.robot.name}
                    ...
                    {this.state.editPart === 8 && 
                        <div>
                        <h1 className='AddRobotPage-title'>Update Images for {this.state.robot.name}</h1>     
                        <AddImages 
                            {... this.props} 
                            name={this.state.robot.name}
                    ...
                    {this.state.editPart === 9 && this.state.categories &&
                        <div>
                        <h1 className='AddRobotPage-title'>Update Categories for {this.state.robot.name}</h1>     
                        <AddCategories 
                            {... this.props} 
                            name={this.state.robot.name}
