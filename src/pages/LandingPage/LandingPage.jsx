        ...
        <div className='LandingPage'>
            <div className='LandingPage-title'>
                ...
                <div className='LandingPage-robots'>
                    ...
                    <Link to="/robots/4"><img className='LandingPage-img LandingPage-metropolis' alt='Metropolis' src='https://i.pinimg.com/originals/ae/f1/b0/aef1b079bd39f3b6c98dc417e534fac1.jpg'></img></Link>
                </div>
            </div>
